...
var GRAVITY, colors, countElem, curColor, i, nextColor, numBalls, random, randomBall, rocket, start, updateCount, _i;
...
rocket.systemForEach('input-balls', ['keyboard-state'], function(rocket, key, keyboard) {
...
randomBall = function() {
  ...
  updateCount(1);
  _ref = rocket.getData('context-2d'), width = _ref.width, height = _ref.height;
